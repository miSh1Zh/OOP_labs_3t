...
class Rectangle : public Figure<T>
{
    public:
        ...
        {
            bool check = (round(sqrt(pow(third.first - second.first, 2) + pow(third.second - second.second, 2))) == round(sqrt(pow(first.first - fourth.first, 2) + pow(first.second - fourth.second, 2)))) and (round(sqrt(pow(second.first - first.first, 2) + pow(second.second - first.second, 2))) == round(sqrt(pow(fourth.first - third.first, 2) + pow(fourth.second - third.second, 2))));
            if(check){
                //X
