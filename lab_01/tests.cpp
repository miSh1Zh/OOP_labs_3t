...
TEST(test_03, basic_test_set){
    ASSERT_TRUE(trace_string("a1012bfsc12")=="1012\n12\n"); //проверка считывания числа, которое стоит в самом конце строки (после неё нет буквы)
}

// TEST(test_x, basic_test_set){
//     ASSERT_TRUE(trace_string("")==""); // проверка на пустой тест (будет вечно ждать ответа)
// }
